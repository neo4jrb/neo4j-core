...
describe Neo4j::Core::Query do
  ...
  describe '#set' do
    ...
    describe ".set(n: {name: 'Brian', age: 30})" do
      it_generates "SET n.name = {n_name}, n.age = {n_age}", {n_name: 'Brian', n_age: 30}
    end

    describe ".set(n: {name: 'Brian', age: 30}, o: {age: 29})" do
      it_generates "SET n.name = {n_name}, n.age = {n_age}, o.age = {o_age}", {n_name: 'Brian', n_age: 30, o_age: 29}
    end

    describe ".set(n: {name: 'Brian', age: 30}).set_props('o.age = 29')" do
      it_generates "SET n.name = {n_name}, n.age = {n_age}, o.age = 29", {n_name: 'Brian', n_age: 30}
    end
  end
  ...
  describe "#on_create_set" do
    ...
    describe ".on_create_set(n: {name: 'Brian', age: 30})" do
      it_generates "ON CREATE SET n.name = {n_name}, n.age = {n_age}", {n_name: 'Brian', n_age: 30}
    end

    describe ".on_create_set(n: {name: 'Brian', age: 30}, o: {age: 29})" do
      it_generates "ON CREATE SET n.name = {n_name}, n.age = {n_age}, o.age = {o_age}", {n_name: 'Brian', n_age: 30, o_age: 29}
    end

    describe ".on_create_set(n: {name: 'Brian', age: 30}).on_create_set('o.age = 29')" do
      it_generates "ON CREATE SET n.name = {n_name}, n.age = {n_age}, o.age = 29", {n_name: 'Brian', n_age: 30}
    end
  end
  ...
  describe "#on_match_set" do
    ...
    describe ".on_match_set(n: {name: 'Brian', age: 30})" do
      it_generates "ON MATCH SET n.name = {n_name}, n.age = {n_age}", {n_name: 'Brian', n_age: 30}
    end

    describe ".on_match_set(n: {name: 'Brian', age: 30}, o: {age: 29})" do
      it_generates "ON MATCH SET n.name = {n_name}, n.age = {n_age}, o.age = {o_age}", {n_name: 'Brian', n_age: 30, o_age: 29}
    end

    describe ".on_match_set(n: {name: 'Brian', age: 30}).on_match_set('o.age = 29')" do
      it_generates "ON MATCH SET n.name = {n_name}, n.age = {n_age}, o.age = 29", {n_name: 'Brian', n_age: 30}
    end
  end
