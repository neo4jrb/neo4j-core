...
{Neo4j::NodeIndex} A simple implementaiton of a lucene index for nodes

{Neo4j::RelationshipIndex} A simple implementaiton of a lucene index for relationships
